...
main(int argc, char** argv)
{
    ...
    try {
        ...
        std::unique_ptr<const Utility::Ac3d_file> floor_file =
            Utility::Ac3d_file_reader::read_file(Utility::File_path("Floor.ac"));
        std::unique_ptr<const Utility::Ac3d_file> model_file =
            Utility::Ac3d_file_reader::read_file(Utility::File_path(visual_model_file));
        std::unique_ptr<const Utility::Ac3d_file> shadow_file =
            Utility::Ac3d_file_reader::read_file(Utility::File_path(shadow_model_file));

        std::shared_ptr<Renderer::Visible_model> floor_model =
            std::make_shared<Renderer::Visible_model>(*floor_file, false);
        std::shared_ptr<Renderer::Visible_model> model =
            std::make_shared<Renderer::Visible_model>(*model_file, false);
        std::shared_ptr<Renderer::Visible_model> shadow_model =
            std::make_shared<Renderer::Visible_model>(*shadow_file, true);

        std::shared_ptr<Renderer::Visible_object> floor_object =
            std::make_shared<Renderer::Visible_object>(floor_model,
                                                       std::shared_ptr<Renderer::Visible_model>());
        ...
        std::shared_ptr<Renderer::Shadow_renderer> shadow_renderer =
            std::make_shared<Renderer::Shadow_renderer>();
