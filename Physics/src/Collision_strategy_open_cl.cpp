    ...
    , m_cl_broadphase_work_group_size( cl_broadphase_work_group_size )
{
    ...
    m_broad_phase_buffer_obj_a  = Utility::Open_cl::create_buffer( m_context, CL_MEM_READ_ONLY, cl_broadphase_work_group_size*sizeof(cl_float)*4 );
    m_broad_phase_buffer_obj_b  = Utility::Open_cl::create_buffer( m_context, CL_MEM_READ_ONLY, cl_broadphase_work_group_size*sizeof(cl_float)*4 );
