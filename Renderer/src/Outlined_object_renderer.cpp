...
Outlined_object_renderer::Outlined_object_renderer(
    const std::shared_ptr<Open_gl_context_store>& context_store)
    : m_context_store(context_store)
{
}

void
Outlined_object_renderer::render(const std::shared_ptr<Visible_object>& object)
{
    ...
    Open_gl_attributes attribs(Open_gl_attributes::ENABLE_BIT | Open_gl_attributes::HINT_BIT |
...
namespace {
void
render_model(Visible_model& model, bool outline_pass)
{
...
void
Outlined_object_renderer::construct_model(const std::shared_ptr<Visible_object>& object)
{
