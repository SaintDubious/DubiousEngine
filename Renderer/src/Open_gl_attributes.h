...
public:
    ...
    /// @brief glDepthFunc
    static void depth_func(int func) { glDepthFunc(func); }

    /// @brief glBlendFunc
    static void blend_func(int s_factor, int d_factor) { glBlendFunc(s_factor, d_factor); }
    ...
    /// @brief glDepthMask
    static void depth_mask(bool flag) { glDepthMask(flag); }

    /// @brief glStencilOp
    static void stencil_op(int fail, int z_fail, int z_pass) { glStencilOp(fail, z_fail, z_pass); }
