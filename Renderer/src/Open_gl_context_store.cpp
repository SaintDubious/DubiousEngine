...
void
Open_gl_context_store::rebuild()
{
    clear_call_lists();
}

Call_list_handle
Open_gl_context_store::create_call_list(int Count)
{
...
void
Open_gl_context_store::clear_call_lists()
{
...
bool
Open_gl_context_store::call_list_exists(Call_list_handle handle) const
{
    return (handle < m_call_lists.size());
}

unsigned int
Open_gl_context_store::get_call_list(Call_list_handle handle) const
{
