...
namespace {
void
draw_shadow_volume(const Math::Local_point& shadow_end, const Math::Local_vector& offset,
                   const Visible_object::Silhouette& sil)
{
...
void
Shadow_renderer::render_shadow_volume(const std::shared_ptr<Visible_object>& object,
