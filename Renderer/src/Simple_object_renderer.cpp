...
Simple_object_renderer::Simple_object_renderer(
...
void
Simple_object_renderer::render(const std::shared_ptr<Visible_object>& object)
{
...
namespace {
void
render_model(Visible_model& model)
{
...
void
Simple_object_renderer::construct_model(const std::shared_ptr<Visible_object>& object)
{
