...
private:
    ...
    QuaternionT(float real, const Triple& imaginary) : m_real(real), m_imaginary(imaginary) {}
...
{
    return equals(a.m_real, b.m_real) && a.m_imaginary == b.m_imaginary;
}
...
QuaternionT<T> operator*(const QuaternionT<T>& a, const QuaternionT<T>& b)
{
    ...
    result.m_real = a.m_real * b.m_real - a.m_imaginary.m_x * b.m_imaginary.m_x -
                    a.m_imaginary.m_y * b.m_imaginary.m_y - a.m_imaginary.m_z * b.m_imaginary.m_z;
    result.m_imaginary.m_x = a.m_real * b.m_imaginary.m_x + a.m_imaginary.m_x * b.m_real +
                             a.m_imaginary.m_y * b.m_imaginary.m_z -
                             a.m_imaginary.m_z * b.m_imaginary.m_y;
    result.m_imaginary.m_y = a.m_real * b.m_imaginary.m_y - a.m_imaginary.m_x * b.m_imaginary.m_z +
                             a.m_imaginary.m_y * b.m_real + a.m_imaginary.m_z * b.m_imaginary.m_x;
    result.m_imaginary.m_z = a.m_real * b.m_imaginary.m_z + a.m_imaginary.m_x * b.m_imaginary.m_y -
                             a.m_imaginary.m_y * b.m_imaginary.m_x + a.m_imaginary.m_z * b.m_real;
